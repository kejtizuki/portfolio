    ...
    return(
      <div className="projectContainer">
        ...
        <div className="cardsFlowBg center">
          ...
          <img src={require("./../assets/img/AH/preset-card-expand.gif")} className="prototypeImgSmall margin40Left gifImgBorder"/>
...
that it displays statistics about user's time spent in loud environments and hearing aid usage.
        ...
        <div className="row margin40">
          <div className="col7"><img src={require("./../assets/img/AH/prototype-choose-filter.gif")} className="prototypeImg gifImgBorder"/><img src={require("./../assets/img/AH/preset-card-expand.gif")} className="prototypeImg margin40Left gifImgBorder"/>
          </div>
